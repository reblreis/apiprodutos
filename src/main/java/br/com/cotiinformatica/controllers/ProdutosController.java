...
@RestController // Annotation do Spring Boot
public class ProdutosController {
	...
	@ApiOperation("Serviço para consulta de produto.")
	...
	public ResponseEntity<List<GetProdutosDTO>> getAll() {
		...
		try {
			...
			for (Produto produto : produtoRepository.findAll()) { //find all = todos os dados do banco de dados
				
				GetProdutosDTO dto = new GetProdutosDTO(); // get para guardar na lista
