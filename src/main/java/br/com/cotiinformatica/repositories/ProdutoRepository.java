...
public class ProdutoRepository {
	...
	public List<Produto> findAll() throws Exception { // método para consultar todos os produtos

		Connection connection = ConnectionFactory.getConnection();

		PreparedStatement statement = connection.prepareStatement("select * from produto"); // consulta
		ResultSet resultSet = statement.executeQuery(); // executa a pesquisa com todos os elementos do banco de dados
	...
	public Produto findById(Integer idProduto) throws Exception { // método para passar o ID do produto
		...
		Produto produto = null; // lista de um produto
